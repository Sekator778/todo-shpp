...
public class Person {
    ...
    public Person(String id, String email, String name, String password, String role, boolean enabled, LocalDate birthday, LocalDateTime created, LocalDateTime modified) {
        this.id = id;
        this.email = email;
        this.name = name;
