...
//    @GetMapping("/user")
//    public ResponseEntity<Iterable<PersonEntity>> getAllUsers() {
//        log.info("used get mapping to /user");
//        return ResponseEntity.ok(userService.findAll());
//    }
//
//    @GetMapping("/user/{id}")
//    public ResponseEntity<PersonEntity> getBookById(@PathVariable int id) {
//        log.info("method get book by id used");
//        Optional<PersonEntity> book = userService.findById(id);
//        return book.map(ResponseEntity::ok).orElseGet(() -> ResponseEntity.notFound().build());
//    }
//
//    @PatchMapping("/user/{id},{roleName}")
//    public ResponseEntity<PersonEntity> setCompleted(@PathVariable int id, @PathVariable String roleName) {
//        log.info("method set or update user by id used");
//        Optional<PersonEntity> user = userService.findById(id);
//        if (user.isEmpty()) {
//            log.warn("{} - its incorrect id check input", id);
//            return ResponseEntity.notFound().build();
//        }
//        PersonEntity result = user.get();
...
//    public ResponseEntity<?> saveUser(@Validated @RequestBody PersonEntity personEntity) {
//        log.info("used get mapping to /user method addUser");
//
//        return userService.save(personEntity);
//    }
//
